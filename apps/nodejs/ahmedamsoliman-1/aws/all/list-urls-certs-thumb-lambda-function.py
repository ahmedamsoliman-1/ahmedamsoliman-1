...
fixed = "https://s3.me-central-1.amazonaws.com/pics.certs.thumb.ahmedalimsoliman.click/"
...
def lambda_handler(event, context):
    ...
    for k in object_names:
        object_urls.append(
            "https://s3.me-central-1.amazonaws.com/pics.certs.thumb.ahmedalimsoliman.click/" + k
        )
