...
region="me-central-1"
cert_stack="fluid-ahmedalimsoliman-click-cert-1"
main_stack="fluid-ahmedalimsoliman-click-dist-1"
DNS="fluid.ahmedalimsoliman.click"
# S3BucketEndpont=$DNS".s3.me-central-1.amazonaws.com"
directory="C:\workspace\s3\fluid-gallery"
